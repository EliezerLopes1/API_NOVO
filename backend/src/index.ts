...
app.put("/editar-info", (req, res) => {
    ...
    let SQL = ("UPDATE Usuarios SET usuario_nome = '"+nome+"', nome_usuario = '"+username+"' WHERE usuario_ID = '5f86aeec-ee1e-4405-8c48-7129cdd72b41'")
...
app.get("/readAcoes", (_, res) => {
    ...
    let SQL = "SELECT tipo_acao, to_char(data_acao, 'DD/MM/YYYY HH24:MI:SS')FROM acoes WHERE id_usuario = '5f86aeec-ee1e-4405-8c48-7129cdd72b41'"
